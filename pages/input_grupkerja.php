								...
								<div class="row">
									<div class="col-md-4 col-12">
										<div class="form-group">
											...
											<select name="hari" multiple data-live-search="true" class="selectpicker form-control" data-actions-box="true" title="Pilih hari" data-max-option="7">
