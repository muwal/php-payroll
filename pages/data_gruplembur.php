<div class="main-content">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<h4 class="card-title"><strong>Grup Lembur</strong></h4>
					...
					<div class="flexbox mb-20">
						...
						<div class="btn-toolbar">
							<div class="btn-group btn-group-sm">
								...
								<a href="?page=inputgruplembur" class="btn" title="Tambah grup" data-provide="tooltip"><i class="ion-plus-round"></i></a>
							</div>
						</div>
					</div>
						...
						<table class="table table-striped table-bordered" cellspacing="0" data-provide="datatables" data-ajax="">
							...
							<tbody>
								<tr>
									...
									<td></td>
									<td>
										<a href="?page=detailgruplembur" class="btn btn-sm btn-secondary">Detail</a>
									</td>
								</tr>
							</tbody>
							<tfoot>
